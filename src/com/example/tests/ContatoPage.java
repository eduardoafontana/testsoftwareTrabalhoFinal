...
/*
	...
	public static void validaRetornoErro() {
		assertEquals("Informe o seu nome", ContatoPage.getNameError());
		assertEquals("Informe o seu e-mail", ContatoPage.getEmailError());
		assertEquals("Informe o seu telefone", ContatoPage.getTelefoneError());
		assertEquals("Informe o sua mensagem", ContatoPage.getMensagemError());
	}
